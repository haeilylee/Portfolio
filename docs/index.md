...
[
  ...
  {"preview":"복잡한 요금 체계를 직관적으로 이해할 수 있도록 정보 구조를 재편하고, 납부 플로우를 3단계로 단순화했어요.","title":"청구 & 수납 관리 서비스 리디자인","desc":"복잡한 요금 체계를 사용자가 직관적으로 이해할 수 있도록 정보 구조를 재편하고, 납부 플로우를 3단계로 단순화했어요.","tags":["Product","Design System"],"date":"2025/06 → 08","link":"/projects/billing","image":"","github_url":"","download_url":""},
  {"preview":"가입 직후 이탈을 줄이기 위해 온보딩 단계를 재구성하고, AI 기반 개인화 추천을 도입해 첫 7일 리텐션을 높였어요.","title":"슈퍼앱 온보딩 플로우 개선","desc":"가입 직후 이탈을 줄이기 위해 온보딩 단계를 재구성하고, AI 기반 개인화 추천을 도입해 첫 7일 리텐션을 높였어요.","tags":["AI","UX Research","Product"],"date":"2025/03 → 05","link":"/projects/onboarding","image":"","github_url":"","download_url":""}
]
-->
...
<a class="project-card" href="/projects/billing" data-tags="Product,Design System">
  ...
  <div class="project-card-top">
    ...
    <div class="project-card-preview">복잡한 요금 체계를 직관적으로 이해할 수 있도록 정보 구조를 재편하고, 납부 플로우를 3단계로 단순화했어요.</div>
...
<a class="project-card" href="/projects/onboarding" data-tags="AI,UX Research,Product">
  ...
  <div class="project-card-top">
    ...
    <div class="project-card-preview">가입 직후 이탈을 줄이기 위해 온보딩 단계를 재구성하고, AI 기반 개인화 추천을 도입해 첫 7일 리텐션을 높였어요.</div>
